const blocks = [
  {
    id: 'text-with-icon', label: '📝 متن با آیکن/عکس', category: 'متن',
  ...
  {
    id: 'image-gallery-2', label: '🖼️ 2 عکس کنار هم', category: 'گالری تصاویر',
  ...
  {
    id: 'image-gallery-3', label: '🖼️ 3 عکس کنار هم', category: 'گالری تصاویر',
  ...
  {
    id: 'image-gallery-4', label: '🖼️ 4 عکس کنار هم', category: 'گالری تصاویر',
  ...
  {
    id: 'cards-row-2', label: '🎴 2 کارت کنار هم', category: 'کارت‌ها',
  ...
  {
    id: 'cards-row-3', label: '🎴 3 کارت کنار هم', category: 'کارت‌ها',
  ...
  {
    id: 'icon-list', label: '✅ لیست با آیکن', category: 'متن',
    content: ''
  },
